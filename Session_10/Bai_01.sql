...
#1,2. Tạo một view có tên view_users_firstname để hiển thị danh sách các người dùng có họ “Nguyễn”. View này cần bao gồm các cột: user_id, username, full_name, email, created_at
create view view_users_firstname
as 
select user_id, username, full_name, email, created_at from users
where full_name like 'Nguyễn%';

#3. Thêm một nhân viên mới vào bảng User có họ “Nguyễn”.
insert into users (username, full_name, gender, email, password, birthdate, hometown)
values ('Dang', 'Nguyễn Hải Đăng', 'nam', 'dang@example.com', '123456', '1967-03-06', 'Hồ Chí Minh');

select * from users;

#4. Thực hiện xóa nhân viên vừa thêm khỏi bảng Users.
delete from users
where username = 'Dang';